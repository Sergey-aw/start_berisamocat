...
const cityData = {
  bg: {
    ...
    profit: 150000,
    listItems: [
      "Успешно работает с 2023 года",
      "Уникальное положение, без конкурентов",
      "Штат сотрудников по развозу самокатов",
      "Инструменты для ремонта",
      "Можно приобрести только самокаты"
    ]
  },
  db: {
    name: 'Дубна',
    ...
    listItems: [
      ...
      "Инструменты для ремонта и запчасти",
